...
import com.android.internal.util.hash.DeviceKeyHandler;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(
                    Settings.System.HASH_HARDWARE_KEYS_DISABLE),
                    false, this);
            mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(
                    Settings.System.HASH_BUTTON_EXTRA_KEY_MAPPING),
                    false, this);
            update();
        }
    ...
    public static void setButtonSetting(Context context) {
        ...
        mButtonDisabled = Settings.System.getIntForUser(
                context.getContentResolver(), Settings.System.HASH_HARDWARE_KEYS_DISABLE, 0,
                UserHandle.USER_CURRENT) == 1;
        if (DEBUG) Log.i(TAG, "setButtonDisable=" + mButtonDisabled);
        mHomeButtonWakeEnabled = Settings.System.getIntForUser(
                context.getContentResolver(), Settings.System.HASH_BUTTON_EXTRA_KEY_MAPPING, 0,
                UserHandle.USER_CURRENT) == 1;
